...
#include <memory>
#include "../../course_work/addcompany.h"
...
QT_MOC_LITERAL(4, 48, 21) // "on_pushButton_clicked"
    ...
    "addcompany\0firstWindow\0\0on_pushButton_2_clicked\0"
...
void addcompany::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<addcompany *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (addcompany::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&addcompany::firstWindow)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject addcompany::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_addcompany.data,
    qt_meta_data_addcompany,
    qt_static_metacall,
    nullptr,
    nullptr
} };
